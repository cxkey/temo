...
class GateIO:
    ...
    def asyc_pairs(self):
        URL = "/api2/1/pairs"
        params=''
        res = yield asyc_httpGet(self.__url, URL, params) 
    ...
    @coroutine
    def asyc_orderBook(self, param):
        URL = "/api2/1/orderBook"
        res = yield asyc_httpGet(self.__url, URL, param)
        raise gen.Return( res )
    ...
    @coroutine
    def asyc_balances(self):
        URL = "/api2/1/private/balances"
        param = {}
        res = yield asyc_httpPost(self.__url, URL, param, self.__apiKey, self.__secretKey)
        raise gen.Return(res)
    ...
    @coroutine
    def asyc_buy(self, currencyPair,rate, amount):
        URL = "/api2/1/private/buy"
        params = {'currencyPair': currencyPair,'rate':rate, 'amount':amount}
        res = yield asyc_httpPost(self.__url, URL, params, self.__apiKey, self.__secretKey)
        raise gen.Return(res)
    ...
    @coroutine
    def asyc_sell(self, currencyPair, rate, amount):
        URL = "/api2/1/private/sell"
        params = {'currencyPair': currencyPair, 'rate': rate, 'amount': amount}
        res = yield asyc_httpPost(self.__url, URL, params, self.__apiKey, self.__secretKey)
        raise gen.Return(res)
    ...
    @coroutine
    def asyc_cancelOrder(self, orderNumber, currencyPair):
        URL = "/api2/1/private/cancelOrder"
        params = {'orderNumber': orderNumber, 'currencyPair': currencyPair}
        res = yield asyc_httpPost(self.__url, URL, params, self.__apiKey, self.__secretKey)
        raise gen.Return(res)
    ...
    # 获取下单状态
    def asyc_getOrder(self, orderNumber, currencyPair):
